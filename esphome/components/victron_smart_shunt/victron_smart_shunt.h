...
class VictronSmartShuntComponent : public uart::UARTDevice, public Component {
 public:
  ...
  void set_min_aux_battery_voltage_sensor(sensor::Sensor *min_aux_battery_voltage_sensor) {
    min_aux_battery_voltage_sensor_ = min_aux_battery_voltage_sensor;
  }
  void set_max_aux_battery_voltage_sensor(sensor::Sensor *max_aux_battery_voltage_sensor) {
    max_aux_battery_voltage_sensor_ = max_aux_battery_voltage_sensor;
  }
  ...
  void set_alarm_reason_sensor(sensor::Sensor *alarm_reason_sensor){
    alarm_reason_sensor_ = alarm_reason_sensor;
  };
  void set_alarm_reason_text_sensor(text_sensor::TextSensor *text_sensor) { alarm_reason_text_sensor_ = text_sensor; }
  void set_depth_of_average_discharge_sensor(sensor::Sensor *depth_of_average_discharge_sensor){
    depth_of_average_discharge_sensor_ = depth_of_average_discharge_sensor;
  };
 ...
 protected:
  ...
  sensor::Sensor *min_aux_battery_voltage_sensor_{nullptr};
  sensor::Sensor *max_aux_battery_voltage_sensor_{nullptr};
  ...
  sensor::Sensor *alarm_reason_sensor_{nullptr};
  sensor::Sensor *depth_of_average_discharge_sensor_{nullptr};
